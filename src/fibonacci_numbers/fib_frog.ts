...
// The goal is to count the minimum number of jumps in which the frog can get to the
// other side of the river (from position −1 to position N). The frog can jump
// between positions −1 and N (the banks of the river) and every position containing
// a leaf.
//
...
export function fib_frog(A: number[]): number {
